...
}`);function xZ({recipe:e,clickFn:t}){return ie(Z0,{overflow:"hidden",w:"100%",gap:1,bg:"white",cursor:"pointer",onClick:()=>{t(e)},_hover:{transform:"scale(1.03)"},children:[ie(yk,{m:"0",p:"0",children:[S(Ul,{src:e.image,alt:e.label,w:"550px",h:"260px",m:"0",p:"0",objectFit:"cover"})," "]}),ie(Q0,{textAlign:"center",children:[S(Ce,{textTransform:"uppercase",color:"gray.400",fontSize:16,mt:".1rem",fontWeight:"bold",children:e.mealType}),S(Ce,{fontStyle:"normal",fontSize:25,fontWeight:"bold",children:e.label}),e.healthLabels.includes("Vegan")&&e.healthLabels.includes("Vegetarian")?ie(Ce,{p:1.5,mt:1,textTransform:"uppercase",children:[S(Xn,{fontWeight:"bold",colorScheme:"purple",children:"Vegan"}),S(Xn,{fontWeight:"bold",colorScheme:"purple",ml:1,children:"Vegetarian"})]}):e.healthLabels.includes("Vegan")?S(Ce,{p:1.5,mt:1,textTransform:"uppercase",children:S(Xn,{fontWeight:"bold",colorScheme:"purple",children:"Vegan"})}):e.healthLabels.includes("Vegetarian")?S(Ce,{p:1.5,mt:1,textTransform:"uppercase",children:S(Xn,{fontWeight:"bold",colorScheme:"purple",children:"Vegetarian"})}):null,e.dietLabels&&e.dietLabels.length>0?S(Ce,{fontWeight:"bold",textTransform:"uppercase",p:1.5,m:0,children:e.dietLabels.map((r,o)=>S(Xn,{fontWeight:"bold",colorScheme:"green",mr:o<e.dietLabels.length-1?1:0,children:r},o))}):null,ie(Ce,{p:1.5,m:0,color:"gray.800",fontWeight:"bold",textTransform:"capitalize",children:["Dish: ",e.dishType]}),e.cautions.length>0&&ie(Ht,{children:[S(Ce,{m:"0 ",p:"1",fontWeight:"normal",children:"Cautions:"}),S(Ce,{textTransform:"uppercase",children:e.cautions.map(r=>S(Xn,{fontWeight:"bold",colorScheme:"red",marginRight:"0.5rem",mt:"0.5rem",children:r},r))})]})]})]})}const SZ=({recipes:e,clickFn:t})=>{const[n,r]=p.exports.useState(""),o=e.filter(i=>Object.values(i).flat().join(" ").replace(/-/g," ").toLowerCase().includes(n.toLowerCase()));return S(Pi,{mb:"3rem",w:"100%",children:ie(bv,{children:[S(bt,{w:"100%",position:"relative",children:S(bt,{children:S(Ul,{src:"https://images.pexels.com/photos/10455982/pexels-photo-10455982.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",alt:"pizza",objectFit:"cover",w:"100%",h:"30rem",mb:"3rem"})})}),ie(bt,{position:"absolute",top:"12rem",left:"25%",w:"60%",children:[S(Pi,{children:S(Xl,{size:"lg",mb:"1rem",color:"green.800",children:"Find a Recipe"})}),S(Mf,{bg:"white",m:"auto",placeholder:"Search Recipes",onChange:i=>r(i.target.value),h:"3rem"})]}),S(Lf,{columns:[1,2,3,4],gap:5,transition:"all 0.3s ease",spacingX:5,w:"80%",children:o.map(i=>S(xZ,{clickFn:t,recipe:i,minHeight:"250px"},i.label))})]})})},CZ="modulepreload",kZ=function(e){return"/"+e},C2={},QE=function(t,n,r){if(!n||n.length===0)return t();const o=document.getElementsByTagName("link");return Promise.all(n.map(a=>{if(a=kZ(a),a in C2)return;C2[a]=!0;const i=a.endsWith(".css"),s=i?'[rel="stylesheet"]':"";if(!!r)for(let c=o.length-1;c>=0;c--){const d=o[c];if(d.href===a&&(!i||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${a}"]${s}`))return;const u=document.createElement("link");if(u.rel=i?"stylesheet":CZ,i||(u.as="script",u.crossOrigin=""),u.href=a,document.head.appendChild(u),i)return new Promise((c,d)=>{u.addEventListener("load",c),u.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${a}`)))})})).then(()=>t())};var _Z=(...e)=>e.filter(Boolean).join(" "),k2={path:ie("g",{stroke:"currentColor",strokeWidth:"1.5",children:[S("path",{strokeLinecap:"round",fill:"none",d:"M9,9a3,3,0,1,1,4,2.829,1.5,1.5,0,0,0-1,1.415V14.25"}),S("path",{fill:"currentColor",strokeLinecap:"round",d:"M12,17.25a.375.375,0,1,0,.375.375A.375.375,0,0,0,12,17.25h0"}),S("circle",{fill:"none",strokeMiterlimit:"10",cx:"12",cy:"12",r:"11.25"})]}),viewBox:"0 0 24 24"},JE=M((e,t)=>{const{as:n,viewBox:r,color:o="currentColor",focusable:a=!1,children:i,className:s,__css:l,...u}=e,c=_Z("chakra-icon",s),d=ht("Icon",e),f={w:"1em",h:"1em",display:"inline-block",lineHeight:"1em",flexShrink:0,color:o,...l,...d},m={ref:t,focusable:a,className:c,__css:f},v=r!=null?r:k2.viewBox;if(n&&typeof n!="string")return S(R.svg,{as:n,...m,...u});const h=i!=null?i:k2.path;return S(R.svg,{verticalAlign:"middle",viewBox:v,...m,...u,children:h})});JE.displayName="Icon";function EZ(e){const{viewBox:t="0 0 24 24",d:n,displayName:r,defaultProps:o={}}=e,a=p.exports.Children.toArray(e.path),i=M((s,l)=>S(JE,{ref:l,viewBox:t,...o,...s,children:a.length?a:S("path",{fill:"currentColor",d:n})}));return i.displayName=r,i}var PZ=EZ({d:"M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z",displayName:"ChevronLeftIcon"});const TZ=p.exports.lazy(()=>QE(()=>Promise.resolve().then(()=>ZE),void 0).then(e=>({default:e.Center}))),FZ=p.exports.lazy(()=>QE(()=>Promise.resolve().then(()=>ZE),void 0).then(e=>({default:e.Button}))),AZ=({recipes:e,clickFn:t})=>S(Ht,{children:S(bt,{children:S(p.exports.Suspense,{fallback:S("div",{children:"Loading..."}),children:S(TZ,{children:S(Z0,{borderRadius:"xl",w:"80%",h:"100%",bg:"white",pb:"2rem",mb:"8rem",children:ie(Q0,{m:"0",p:"0",children:[S(Ul,{src:e.image,alt:e.label,w:"100%",h:"350px",objectFit:"cover",overflow:"hidden"}),ie(Zl,{mt:"6",spacing:"3",pl:"1.5rem",children:[ie(sd,{gap:5,flexWrap:["wrap","nowrap"],flexDirection:["column","row"],children:[ie(bt,{w:"50%",p:".5rem",children:[" ",S(Ce,{fontWeight:"bold",textTransform:"uppercase",fontSize:13,color:"gray.400",children:e.mealType}),S(Xl,{size:"md",children:e.label}),ie(Ce,{children:["Total Cooking Time: ",e.totalTime," Minutes"," "]}),ie(Ce,{children:["Servings: ",e.yield," "]}),S(Ce,{fontWeight:"bold",children:"Ingredients"}),S(Ce,{children:e.ingredientLines.map(n=>S(Ce,{children:n},n))})]}),S(vv,{}),ie(bt,{w:"50%",p:".5rem",children:[" ",S(Ce,{children:"Health labels"}),S(Ce,{textTransform:"uppercase",children:e.healthLabels.map(n=>S(Xn,{fontWeight:"bold",colorScheme:"purple",marginRight:"0.5rem",mt:"0.5rem",children:n},n))}),e.dietLabels.length>0&&ie(Ht,{children:[S(Ce,{m:"0 ",p:"1",fontWeight:"normal",children:"Diet"}),S(Ce,{textTransform:"uppercase",children:e.dietLabels.map(n=>S(Xn,{fontWeight:"bold",colorScheme:"red",marginRight:"0.5rem",mt:"0.5rem",children:n},n.label))})]}),e.cautions.length>0&&ie(Ht,{children:[S(Ce,{m:"0 ",p:"1",fontWeight:"normal",children:"Cautions:"}),S(Ce,{textTransform:"uppercase",children:e.cautions.map(n=>S(Xn,{fontWeight:"bold",colorScheme:"red",marginRight:"0.5rem",mt:"0.5rem",children:n},n))})]}),S(Ce,{mt:".8rem",children:"Total Nutrients"}),ie(sd,{flexDirection:["column","row"],flexWrap:"wrap",children:[ie(bt,{mr:5,mt:2,children:[ie(Ce,{children:[Math.floor(e.totalNutrients.ENERC_KCAL.quantity)," "]}),S(Ce,{children:S(ao,{variant:"outline",colorScheme:"green",textTransform:"uppercase",children:"Calories"})})]}),ie(bt,{mr:5,mt:2,children:[ie(Ce,{children:[" ",Math.floor(e.totalNutrients.CHOCDF.quantity)," ",e.totalNutrients.CHOCDF.unit]}),ie(Ce,{children:[" ",S(ao,{variant:"outline",colorScheme:"green",textTransform:"uppercase",children:e.totalNutrients.CHOCDF.label})]})]}),ie(bt,{mr:5,mt:2,children:[ie(Ce,{children:[Math.floor(e.totalNutrients.PROCNT.quantity)," ",e.totalNutrients.PROCNT.unit]}),ie(Ce,{children:[" ",S(ao,{variant:"outline",colorScheme:"green",textTransform:"uppercase",children:e.totalNutrients.PROCNT.label})]})]}),ie(bt,{mr:5,mt:2,children:[ie(Ce,{children:[Math.floor(e.totalNutrients.FAT.quantity)," ",e.totalNutrients.FAT.unit]}),ie(Ce,{children:[" ",S(ao,{variant:"outline",colorScheme:"yellow",textTransform:"uppercase",children:e.totalNutrients.FAT.label})]})]}),ie(bt,{mr:5,mt:2,children:[ie(Ce,{children:[Math.floor(e.totalNutrients.CHOLE.quantity)," ",e.totalNutrients.CHOLE.unit]}),ie(Ce,{children:[" ",S(ao,{variant:"outline",colorScheme:"pink",textTransform:"uppercase",children:e.totalNutrients.CHOLE.label})]})]}),ie(bt,{mr:5,mt:2,children:[" ",ie(Ce,{children:[Math.floor(e.totalNutrients.NA.quantity)," ",e.totalNutrients.NA.unit]}),ie(Ce,{children:[" ",S(ao,{variant:"outline",colorScheme:"green",textTransform:"uppercase",children:e.totalNutrients.NA.label})]})]})]})]})]}),S(p.exports.Suspense,{fallback:S("div",{children:"Loading..."}),children:ie(FZ,{pb:"0.2rem",pl:".5rem",bg:"blue.500",w:"fit-content",onClick:()=>t(null),color:"white",children:[S(X0,{fontSize:25,colorScheme:"white","aria-label":"previous page",icon:S(PZ,{}),onClick:()=>t(null),color:"white"}),"Back to overview"]})})]})]})})})})})}),IZ=e=>ie(Ht,{children:[S(Pi,{bg:"green.500",children:S(Xl,{p:"1rem",color:"white",fontSize:"2xl",onClick:()=>{window.location.href="/"},cursor:"pointer",_hover:{color:"orange.200"},children:"Winc Recipe App"})}),e.children]}),RZ=()=>S(bt,{w:"100%",h:"10rem",bg:"gray.600",p:"2rem",children:ie(bt,{w:"80%",h:"7rem",m:"auto",color:"green.200",textAlign:"Center",p:"3rem",children:[S(Ce,{children:"Winc Recipes App"}),S(Ce,{children:"Copyright \xA9 2023 All rights reserved."})]})}),NZ=()=>{const[e,t]=p.exports.useState(),n=wZ.hits.map(r=>r.recipe);return ie(IZ,{children:[S(bt,{w:"100%",h:"100%",children:S(Pi,{children:S(Lf,{w:"100%",children:e?S(AZ,{recipes:e,clickFn:t}):S(SZ,{recipes:n,clickFn:t})})})}),S(RZ,{})]})};Fg.createRoot(document.getElementById("root")).render(S(P.StrictMode,{children:S(XE,{children:S(NZ,{})})}));
